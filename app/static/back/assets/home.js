...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".activity-log").on("click", function () {
  console.log("hello");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".card-log").toggleClass("show");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").toggleClass("log-toggled");
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".custom-file-input").on("change", function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings(".custom-file-label").addClass("selected-file").html("").append("<p> (" + fileName + ")</p>");
});
